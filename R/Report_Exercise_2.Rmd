...
# add label for the dashed line 
  ...
  annotate("text", x = 0.5 , y =  145, hjust = 0, 
           label = "Overall median [31.5 ppm]", color = "royalblue") +
  annotate("text", x = 0.5 , y =  130, hjust = 0, 
...
#change the size of the labels  
  ...
  geom_vline(xintercept = median(airquality_mutated$Ozone, na.rm = TRUE)
             , linetype = "dotdash",color = "royalblue", size = 0.3) +
  annotate("text", x = 125, hjust = 0, y = 0.024, 
           label="Threshold value [60 ppb]",color = "darkmagenta") +
  annotate("text", x = 125,hjust = 0, y = 0.022, vjust = 0.02, 
           label="Median [31.5 ppm]", color = "royalblue") +
#chose no gridlines  
  theme_bw() +
  theme(panel.border = element_rect(colour = "black", fill = NA, linewidth = 1))
```
