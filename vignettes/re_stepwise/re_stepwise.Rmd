...
# Access to the data
url <- "https://raw.githubusercontent.com/geco-bern/agds/main/data/FLX_CH-Lae_FLUXNET2015_FULLSET_HH_2004-2006_CLEAN.csv"

# Read in the data directly from URL
database.S1 <- read.table(url, header = TRUE, sep = ",")

# Write a CSV file in the respiratory
write_csv(database.S1,"../data/re_stepwise/FLX_CH-Lae_FLUXNET2015_FULLSET_HH_2004-2006_CLEAN.csv")
```
...
```{r Read_the_data}
database <- read_csv("../data/re_stepwise/FLX_CH-Lae_FLUXNET2015_FULLSET_HH_2004-2006_CLEAN.csv")
