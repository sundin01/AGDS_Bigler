...
The horizontal lines implies that there are empty rows. But this is not a
...
After the call we want know, wheater the function has worked and if there
any improvement. That is why we make a quality control call again. We can
