...
CO2 concentrations that have been measured during the experiment. It makes
...
CO2 concentration that never existed in the experimental setup. In this
...
considerations and the same argumentation as for task one). We calculate
the LRR with both methods because we want to demonstrate that there is a
difference as well.
