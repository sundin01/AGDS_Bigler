...
is higher in the KNN model than in the lm model. But be careful: RMSE and RSQ in the
...
want the model with the lowest MAE in the test data. For that we mark the minimum
of the RMSE test data hyperbola (red point = 25).
